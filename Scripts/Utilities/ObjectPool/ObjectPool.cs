...
public class ObjectPool : MonoBehaviour {
    ...
    /// <summary>
    /// Gets a new object for the name type provided.  If no object type exists or if only pooled is true and there is no objects of that type in the pool
    ...
    /// </param>
    public GameObject GetObjectForType(string objectName, bool onlyPooled = false)
    {
        ...
        if (objectPoolEntry.objectsInPool > 0)
        {
            ...
            pooledObject.transform.SetParent(null);//.parent = null;
